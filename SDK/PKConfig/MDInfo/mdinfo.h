...
#define CNV_ENDIAN(n)		(((n&0xFF000000)>>24)+((n&0x00FF0000)>>8)+((n&0x0000FF00)<<8)+((n&0x000000FF)<<24))

#define IH_NMLEN		32		

unsigned long ulFlashBase_wbl = 0x40000000;
unsigned long ulFlashBase_ub = 0x14000000;
