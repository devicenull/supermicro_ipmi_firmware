...
for imagenum in images:
	...
	if imagestart < new_image.tell():
		print "ERROR: Previous image was too big, and has overriten data where the current image should begin.  Current position: 0x%x , image start: 0x%x" % (new_image.tell(), imagestart)
		print "Aborting."
		sys.exit(1)
